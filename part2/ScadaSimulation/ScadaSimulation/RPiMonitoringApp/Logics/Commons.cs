...
namespace SmartHomeMonitoringApp.Logics
{
    public class Commons
    {
        ...
        public static string BROKERHOST { get; set; } = "210.119.12.62";    // IP

        public static string MQTTTOPIC { get; set; } = "pknu/rpi/control/"; // 경로
        ...
        // UserControl 같이 자식 클래스면서 MetroWindow를 직접 사용하지 않아 MahApps에 있는 Metro메시지 창 못쓸때
